...
namespace BCLib.BT
{
    public class BehaviorTree<T> where T : class, ITreeContext
    {
    ...
    public class NodeMap<T> where T : class, ITreeContext
    {
    ...
    public abstract class Node<T> where T: class, ITreeContext
    {
    ...
    public abstract class ParentNode<T> : Node<T> where T : class, ITreeContext
    {
    ...
    public class PriorityNode<T> : ParentNode<T> where T : class, ITreeContext
    {
    ...
    public class SequenceNode<T> : PriorityNode<T> where T : class, ITreeContext
    {
        public SequenceNode(T context, Node<T>[] children) : base(context, true, false, children){}
    }

    public class LoopNode<T> : PriorityNode<T> where T : class, ITreeContext
    {
    ...
    public class RandomNode<T> : ParentNode<T> where T : class, ITreeContext
    {
        private int _runningIndex;
    ...
    public class ConcurrentNode<T> : ParentNode<T> where T : class, ITreeContext
    {
    ...
    public abstract class DecoratorNode<T> : Node<T> where T : class, ITreeContext
    {
    ...
    public class ConvertToNode<T> : DecoratorNode<T> where T : class, ITreeContext
    {
    ...
    public class InverterNode<T> : DecoratorNode<T> where T : class, ITreeContext
    {
    ...
    public class TimerNode<T> : DecoratorNode<T> where T : class, ITreeContext
    {
    ...
    public abstract class LeafNode<T> : Node<T> where T : class, ITreeContext
    {
